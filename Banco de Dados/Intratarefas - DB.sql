...
-- Schema Intratarefas
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Intratarefas` DEFAULT CHARACTER SET utf8 ;
USE `Intratarefas` ;

-- -----------------------------------------------------
-- Table `Intratarefas`.`funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Intratarefas`.`funcionario` (
...
-- -----------------------------------------------------
-- Table `Intratarefas`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Intratarefas`.`cliente` (
...
-- -----------------------------------------------------
-- Table `Intratarefas`.`manutencao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Intratarefas`.`manutencao` (
  ...
  CONSTRAINT `fk_manutencao_cliente`
    ...
    REFERENCES `Intratarefas`.`cliente` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manutencao_funcionario1`
    FOREIGN KEY (`funcionario_idfuncionario`)
    REFERENCES `Intratarefas`.`funcionario` (`idfuncionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `Intratarefas`.`procedimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Intratarefas`.`procedimento` (
...
-- -----------------------------------------------------
-- Table `Intratarefas`.`manutencao_has_procedimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Intratarefas`.`manutencao_has_procedimento` (
  ...
  CONSTRAINT `fk_manutencao_has_procedimento_manutencao1`
    ...
    REFERENCES `Intratarefas`.`manutencao` (`atendimento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manutencao_has_procedimento_procedimento1`
    FOREIGN KEY (`procedimento_idprocedimento`)
    REFERENCES `Intratarefas`.`procedimento` (`idprocedimento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
select cliente.nome, funcionario.user, manutencao.equipamento, manutencao.defeito,  manutencao.status 
from manutencao 
inner join cliente 
...
where funcionario.user = "tec";

select cliente.nome, manutencao.equipamento, manutencao.defeito,
from manutencao
inner join cliente 
on cliente.idcliente = manutencao.cliente_idcliente 
where manutencao.atendimento = "tec";