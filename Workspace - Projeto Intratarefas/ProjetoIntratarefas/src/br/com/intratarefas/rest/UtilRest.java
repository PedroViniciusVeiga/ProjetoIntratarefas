...
public class UtilRest {
	/*
	 * Abaixo o método responsavel por enviar a resposta ao cliente sobre
	 * a transação realizadam(linclusão, consulta, edição ou exclusão) caso 
	...
	public Response buildErrorResponse(String str) {
		/*
		 * Abaixo o objeto rb recebe o status erro.
		 */
		...
		/*
		 * Define o tipo de retorno desta entidade (objeto), que nesse caso é definido como texto simples.
		 */
