package br.com.intratarefas.filter;
...
//Verificando se usuário é nulo
			if (usuario == null){
				System.out.println("usernula");
//Se for redireciona para a apresentação da mensagem de

				((HttpServletResponse)response).sendRedirect("http://localhost:8080/ProjetoIntratarefas/erro.html");
			} else {
				/*
